...
public class MmsDownloadJob extends BaseJob {
      ...
      throws MmsException
  {
    ...
    IncomingMediaMessage   message      = new IncomingMediaMessage(from, group, body, TimeUnit.SECONDS.toMillis(retrieved.getDate()), -1, System.currentTimeMillis(), attachments, subscriptionId, 0, false, false, false, false, Optional.of(sharedContacts), false, false);
